...
func requirementsInSync(lock *manifest.Lockfile, mani *manifest.Manifest) (bool, error) {
	if mani == nil {
...
// DependenciesSynced returns true if the dependencies of this instance do not
...
func (i *Instance) DependenciesSynced() (bool, error) {
	return dependenciesInSync(i.Lockfile, i.Manifest)
}

// RequirementsSynced returns true if the requirements of this instance do not
...
func (i *Instance) RequirementsSynced() (bool, error) {
	return requirementsInSync(i.Lockfile, i.Manifest)
}
