...
func init() {
	launchCmd.Flags().BoolP("accept-eula", "a", false, "Accept Mojang's Minecraft eula. See https://account.mojang.com/documents/minecraft_eula")
	launchCmd.Flags().BoolP("system-java", "", false, "Use system java instead of internal installation")
	...
	viper.BindPFlag("useSystemJava", launchCmd.Flags().Lookup("system-java"))
	viper.BindPFlag("acceptMinecraftEula", launchCmd.Flags().Lookup("accept-eula"))
}
